...
class Api : public QObject {
 ...
 public:
    ...
    int wifiAddNetwork(const QString &ssid, const QString &ssidHex = QString(), const QString &password = "",
                       WifiEnums::WifiSecurity security = WifiEnums::WifiSecurity::AUTO, bool hidden = false);
