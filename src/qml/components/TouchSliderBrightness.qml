...
Item {
    ...
    readonly property real sweepGain: Config.touchSliderGainBrightness
    ...
    Connections {
        ...
        function onTouchPressed() {
            ...
            sliderContainer.touchScale = 255 * sliderContainer.sweepGain / axisRange;
        ...
        function onTouchXChanged(x) {
            ...
            const newTarget = Math.max(0, Math.min(255, sliderContainer.targetBrightness + step));
            if (newTarget === sliderContainer.targetBrightness) {
                // pinned at an end stop
                return;
            }
            sliderContainer.targetBrightness = newTarget;
