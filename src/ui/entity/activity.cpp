...
Activity::Activity(const QString &id, QVariantMap nameI18n, const QString &language, const QString &icon,
    ...
    : Base(id, nameI18n, language, icon, area, Type::Activity, enabled, attributes, integrationId, false, parent),
      m_currentStep(this) {
